...
public class WebsSocketMessage {
	...
	private WebSocketModelResponse parseWebSocketMessage(String message, WebSocketModelResponse responseMessage)
			throws IOException {
		if (message != null) {
			...
			return new WebSocketModelResponse(responseMessage.getDriverId(), responseMessage.getDeviceId(),
