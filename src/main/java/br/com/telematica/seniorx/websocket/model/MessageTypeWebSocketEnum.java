...
public abstract class MessageTypeWebSocketEnum {
    ...
    public enum TypeWebSocketEnum {
                                   ...
                                   SET_DEVICE_EMERGENCY,
                                   UNSET_DEVICE_EMERGENCY,
                                   ...
                                   REMOVE_ALLOW_CARD_LIST,
                                   REMOVE_BIOMETRY_LIST,
                                   
                                   INCLUDE_CARD,
                                   EXCLUDE_CARD,
                                   
                                   DEVICE,
                                   REP_MANUFACTURER_UPDATED,
                                   
                                   LOAD_HOLIDAY_LIST,
                                   REMOVE_HOLIDAY_LIST,
                                   
                                   ACTIVATE_DEVICE_OUTPUT,
                                   COLLECT_EVENTS,
                                   
                                   DEVICE_INPUT_STATUS,
                                   DEACTIVATE_DEVICE_OUTPUT,
