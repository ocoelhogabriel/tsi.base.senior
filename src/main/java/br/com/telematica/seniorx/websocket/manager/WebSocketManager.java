...
public class WebSocketManager extends SeniorXService {
    ...
    public void removePendencyMessageWebSocket(WebSocketModelResponse message) {
        ...
        try {
            String pendencyType = message.getPendencyType();
            switch (pendencyType) {
                case "CREDENTIAL_FACIAL_LIST" -> processPendency(allPendencyBody.getLoadCredentialFacialList(), "CREDENTIAL_FACIAL_LIST");
                case "REMOVE_HOLIDAY_LIST" -> processPendency(allPendencyBody.getRemoveHolidayList(), "REMOVE_HOLIDAY_LIST");
                ...
                case "ACTIVATE_DEVICE_OUTPUT" -> processPendency(allPendencyBody.getActivateDeviceOutput(), "ACTIVATE_DEVICE_OUTPUT");
                case "COLLECT_EVENTS" -> processPendency(allPendencyBody.getCollectEvent(), "COLLECT_EVENTS");
                case "DEACTIVATE_DEVICE_OUTPUT" -> processPendency(allPendencyBody.getDeactivateDeviceOutput(), "DEACTIVATE_DEVICE_OUTPUT");
                case "PERSON_AREA_UPDATED" -> processPendency(allPendencyBody.getPersonLocationUpdated(), "PERSON_AREA_UPDATED");
                ...
                case "DEVICE_DISPLAY_MESSAGE" -> processPendency(allPendencyBody.getDeviceDisplayMessage(), "DEVICE_DISPLAY_MESSAGE");
    ...
    public void handleActiveDeviceOutputPendency(List<ActiveDeviceOutputPendency> message, AllPendency allPendencyBody) {
        try {
    ...
    public void handleDeviceDisplayMessagePendency(List<DeviceDisplayMessagePendency> message, AllPendency allPendencyBody) {
        try {
    ...
    public void handleDeactiveDeviceOutputPendency(List<DeactiveDeviceOutputPendency> message, AllPendency allPendencyBody) {
        try {
...
//
// if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.DEVICE_STATUS.toString()))
// // seniorHandler.handleDeviceStatus(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.DEVICE_DATE_TIME.toString()))
// // seniorHandler.handleDeviceDateTime(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.DEVICE.toString()))
// // seniorHandler.handleDevice(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.SET_DEVICE_EMERGENCY.toString()))
// // seniorHandler.handleSetDeviceEmergency(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.UNSET_DEVICE_EMERGENCY.toString()))
// // seniorHandler.handleUnsetDeviceEmergency(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.REP_MANUFACTURER_UPDATED.toString()))
// // seniorHandler.handleManufatureRep(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.ALLOW_CARD_LIST.toString()))
// // seniorHandler.handleAllowCardList(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.REMOVE_ALLOW_CARD_LIST.toString()))
// // seniorHandler.handleRemoveAllowCardList(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.BIOMETRY_LIST.toString()))
// // seniorHandler.handleAllowBiometryList(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.REMOVE_BIOMETRY_LIST.toString()))
// // seniorHandler.handleAllowBiometryList(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.INCLUDE_BIOMETRY.toString()))
// // seniorHandler.handleIncludeBiometry(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.EXCLUDE_BIOMETRY.toString()))
// // seniorHandler.handleExcludeBiometry(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.INCLUDE_CARD.toString()))
// // seniorHandler.handleIncludeCard(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.EXCLUDE_CARD.toString()))
// // seniorHandler.handleExcludeCard(message);
// return;
// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.UPDATE_PERSON_REP.toString()))
// // seniorHandler.handleUpdateRepPerson(message);
//// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.CREDENTIAL_FACIAL_LIST.toString()))
//// // seniorHandler.handleCredentialFacialList(message);
//// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.UPDATE_FIRMWARE.toString()))
//// // seniorHandler.handleUpdateFirmware(message);
//// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.LOAD_HOLIDAY_LIST.toString()))
//// // seniorHandler.handleLoadHolidayList(message);
//// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.REMOVE_HOLIDAY_LIST.toString()))
//// // seniorHandler.handleRemoveHolidayList(message);
//// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.DEVICE_INPUT_STATUS.toString()))
//// // seniorHandler.handleDeviceInputStatus(message);
//// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.BLOCK_DEVICE.toString()))
//// // seniorHandler.handleBlockDevice(message);
//// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.UNBLOCK_DEVICE.toString()))
//// // seniorHandler.handleUnblockDevice(message);
//// else if
// ((message.getPendencyType()).equals(MessageTypeWebSocketEnum.TypeWebSocketEnum.COLLECT_EVENTS.toString()))
